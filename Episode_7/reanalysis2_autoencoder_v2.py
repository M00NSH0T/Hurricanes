...
from reanalysis2_generator_v2 import DataGenerator
...
#                    validation_data=validation_generator,
                    ...
                    verbose=1,
                    epochs=1000,
                    callbacks=[TensorBoard(log_dir='c:\\tensorboard\\autoencoder_v2')])
...
autoencoder_path=os.path.join(data_dir,"autoencoder_v2")
decoder_path=os.path.join(data_dir,"decoder_v2")
encoder_path=os.path.join(data_dir,"encoder_v2")  
